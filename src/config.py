...
WELCOME_CHANNEL_ID =  os.environ.get("DS_CHANNEL_ID")

# 4- your id for leave message
AUTHOR_ID =  os.environ.get("DS_ID")

# coin market cap api key for cryptocurrency commands
